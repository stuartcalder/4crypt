...
namespace fourcrypt
 {
  class Core
   ...
   public:
    ...
    static constexpr const uint8_t MEM_FAST   = 21; // 128 Mebibytes.
    ...
    struct PlainOldData
     {
      ...
      TSC_CSPRNG                  rng;    // Skein512-based Pseudorandom Number Generator.
      alignas(uint64_t) uint8_t   hash_buffer     [TSC_THREEFISH512_BLOCK_BYTES * 2]; // Enough room for 2 64 byte hashes in 1 buffer.
      ...
      TSC_UBI512*                 ubi512; // Point to the TSC_UBI512 struct internal to @rng.
